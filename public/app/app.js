...
angular.module('app').config(function($routeProvider, $locationProvider) {
	...
	$routeProvider
		...
		.when('/courses', {templateUrl: '/partials/courses/courseList', controller: 'mvCourseListCtrl'})
		.when('/courses/:id', {templateUrl: '/partials/courses/courseDetails', controller: 'mvCourseDetailsCtrl'});
});
